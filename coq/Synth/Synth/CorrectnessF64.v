...
(** ** F64 Arithmetic Operations — VFP, no semantics *)
...
Proof.
  (* ADMITTED: VADD_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VSUB_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VMUL_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VDIV_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VSQRT_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VABS_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
Proof.
  (* ADMITTED: VNEG_F64 has no modeled semantics — requires Flocq *)
Admitted.
...
(** ADMITTED: VCMP_F64 has no modeled semantics *)
...
Proof.
  (* ADMITTED: VCMP_F64 has no modeled semantics — requires Flocq *)
Admitted.
